...
function f6() {
  const key = document.querySelector(".i-61").value;
  const value = document.querySelector(".i-62").value;
...
function f7() {
  ...
  const inputKey = document.querySelector(".i-7").value;
...
function f8() {
  ...
  const inputKey = document.querySelector(".i-8").value;

  for (const key in a8) {
    if (inputKey === key) {
      output.innerHTML = a8[key];
      return;
    }
...
function f9() {
  ...
  const inputValue = Number(document.querySelector(".i-9").value);
...
function f11() {
  const inputKey = document.querySelector(".i-11").value;
...
function f12() {
  const inputValue = Number(document.querySelector(".i-12").value);
...
function f18() {
  ...
  for (const key in a18) {
    if (key === inputValue) {
      const stationList = a18[key].join(" ");
      markup += `${stationList} `;
    }
  }
...
function f20() {
  ...
  for (const branch in a20) {
    for (const station of a20[branch]) {
      if (station.includes(2)) {
        markup += `${station[0]} `;
      }
    }
  }
