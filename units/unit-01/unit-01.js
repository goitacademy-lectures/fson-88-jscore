...
document.getElementById("seven").innerHTML = multiply;
// або ж зразу присвоїти результат множення
...
document.querySelector(".output-8").innerHTML = "world";
...
// Task 12.
//  На сторінці створено div.output-12. Отримайте його у змінну a. За допомогою innerHTML запишіть всередину змінної a число 3.1415. Вивчіть як у JS пишуться дробні числа - через крапку чи через кому
let a = document.querySelector(".output-12");
a.innerHTML = 3.1415;
...
const output13 = document.querySelector(".output-13");
output13.innerHTML =
  '<img src="https://media.giphy.com/media/7AyIKaV7uEeIw/giphy.gif" alt="Hello from mr.Bin" />';

// Task 14.
//  Створіть дві змінні num1 = 6, num2 = 3. У div.output-14 виведіть результат множення num1 на num2.
let z1 = 6;
let z2 = 3;
document.querySelector(".output-14").innerHTML = z1 * z2;
...
let output17 = document.querySelector(".output-17");
...
let output18 = document.querySelector(".output-18");
...
let output19 = document.querySelector(".output-19");
console.log(output19);
output19 = document.querySelector(".output-19-test");
console.log(output19);
...
let output20 = document.querySelector(".output-20");
output20.textContent = "<h2>Hi</h2>";
