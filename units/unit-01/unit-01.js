...
document.querySelector(".output-11").innerHTML += "456"; //береться побереднє значенння та +=
...
let output13 = document.querySelector(".output-13");
output13.innerHTML = '<img src="https://itgid.info/img/js20/js20_unit_01.png" alt="js"></img>';
...
const output20 = document.querySelector(".output-20");
