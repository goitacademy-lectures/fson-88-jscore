...
let message = document.getElementById("six").innerHTML = "Hello World";
...
let element = document.getElementById("seven").innerHTML = 12 * 12;
// Task 8.
...
console.log(document.querySelector("h2 > .output-8"));

// Task 10.
// На сторінці створено div.output-10. За допомогою innerHTML запишіть всередину наступний рядок '<h2>Hi</h2>'.
const text = "Hi";
document.querySelector(".output-10").innerHTML = `<h2 style='color: red'>${text}</h2>`;
console.log(document.querySelector(".output-10"));
...
const a = document.querySelector(".output-12");
a.innerHTML = 3.1415;
...
const b = document.querySelector(".output-13");
...
const output17 = document.querySelector('.output-17');
