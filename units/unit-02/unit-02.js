...
function t12() {  
  const firsName = document.querySelector(".i-12-1").value; // має бути вказано .value !!!
  const secondName = document.querySelector(".i-12-2"); 
  
  document.querySelector(".out-12").innerHTML = `Hello ${firsName} ${secondName.value}`; // або тут !!!
}
...
function t13() {
  const firsNumb = Number(document.querySelector(".i-13-1").value); // має бути вказано Number !!!
  const secondNumb = document.querySelector(".i-13-2").value; 
  document.querySelector(".out-13").innerHTML = firsNumb + Number(secondNumb); // або тут !!!
}
...
function t14() {
  const element = document.querySelector(".i-14").value = 'Go'; 
}
...
function t16() {
  const firsNumb = document.querySelector(".i-16-1").value;
  const secondNumb = document.querySelector(".i-16-2").value; 
  document.querySelector(".out-16").innerHTML = firsNumb + secondNumb; 
}
...
function t19() {
  const firsNumb = Number(document.querySelector(".i-19-1").value);
  const secondNumb = Number(document.querySelector(".i-19-2").value); 
  document.querySelector(".out-19").innerHTML = firsNumb + secondNumb;
