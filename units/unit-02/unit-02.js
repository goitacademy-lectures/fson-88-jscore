...
function t10() {
  ...
  document.querySelector(".out-10").innerHTML = element.value * 20;
}
...
function t12() {
  {
    const textName = document.querySelector(".i-12-1");
    const textLastName = document.querySelector(".i-12-2");
    document.querySelector(".out-12").innerHTML =
      "Hello " + textName.value + " " + textLastName.value;
  }
}
...
function t14() {
  const element14 = document.querySelector(".i-14");
  document.querySelector(".i-14").innerHTML = element14.value;
  element14.value = "Go";
}
...
function t15() {
  const element15 = document.querySelector(".i-15");
  if (element15) {
    element15.style.border = "4px solid red";
  }
}
...
function t16() {
  const a2 = document.querySelector(".i-16-1");
  const b2 = document.querySelector(".i-16-2");
  document.querySelector(".out-16").innerHTML =
    parseInt(a2.value) + parseInt(b2.value);
}
...
function t19() {
  ...
  document.querySelector(".out-19").innerHTML = parseFloat(a) + parseFloat(b);
}
