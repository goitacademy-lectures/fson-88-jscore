...
function t9() {
  const data9 = document.querySelector(".i-9").value;
...
function t10() {
  document.querySelector(".out-10").innerHTML = document.querySelector(".i-10").value *20;
}
...
function t11() {
  document.querySelector(".out-11").innerHTML = document.querySelector(".i-11").value + 55;
}
...
function t12() {
  ...
  const lname = document.querySelector(".i-12-2").value;
  document.querySelector(".out-12").innerHTML = 'Hello ' + name + ' ' + lname;
}
