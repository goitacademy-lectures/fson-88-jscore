...
const c = 7;
const d = 9;
document.querySelector(".output-2").textContent = c / d;

// Task 3.
//  Створіть дві змінні e = 3 та f = 5. Виведіть на сторінку в .output-3 результат додавання e + f.
const e = 7;
const f = 9;
document.querySelector(".output-3").textContent = e + f;
...
function fn9() {
  const inputEl = document.querySelector(".field-9");

  document.querySelector(".output-9").innerHTML = inputEl.value;
  inputEl.value = "";
}
...
function fn10() {
  const inputEl = document.querySelector(".field-10");
  document.querySelector(".output-10").innerHTML = inputEl.value * 20;
}
...
function fn11() {
  const inputEl = document.querySelector(".field-11");
  document.querySelector(".output-11").innerHTML = inputEl.value + 55;
}
...
// Звертаємо увагу на те, що ми працюємо у відповідності до завдання.Hello - з великої літери. Між Hello ім'я один пробіл

function fn12() {
  const userName = document.querySelector(".field-12-1").value;
  const userSurname = document.querySelector(".field-12-2").value;

  console.log(userName);
  console.log(userSurname);

  document.querySelector(".output-12").innerHTML = `Hello ${userName} ${userSurname}`;
}
...
function fn13() {
  const firstNumber = document.querySelector(".field-13-1").value;
  const secondNumber = document.querySelector(".field-13-2").value;

  document.querySelector(".output-13").innerHTML = Number(firstNumber) + Number(secondNumber);
}
...
function fn14() {
  document.querySelector(".field-14").value = "Go";
}
...
function fn15() {
  const inputEl = document.querySelector(".field-15");
...
function fn16() {
  const firstValue = document.querySelector(".field-16-1").value;
  const secondValue = document.querySelector(".field-16-2").value;

  document.querySelector(".output-16").innerHTML = firstValue + secondValue;
}
...
function fn17() {
  ...
  document.querySelector(".output-17-1").innerHTML = +a; // оператор + перед змінною спробує привести заначення до числа
...
function fn18() {
  const a = document.querySelector(".field-18").value;
  document.querySelector(".output-18").innerHTML = parseFloat(a);
}
...
function fn19() {
  const firstNumber = document.querySelector(".field-19-1").value;
  const secondNumber = document.querySelector(".field-19-2").value;

  document.querySelector(".output-19").innerHTML = Number(firstNumber) + Number(secondNumber);
}
