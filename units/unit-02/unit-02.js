...
function fn9() {
  const data = document.querySelector(".field-9");
  document.querySelector(".output-9").innerHTML = data.value;
  data.value = "";
...
function fn10() {
  const data = document.querySelector(".field-10");
  document.querySelector(".output-10").innerHTML = Number(data.value) * 20;
}
...
function fn11() {
  const data = document.querySelector(".field-11");
  document.querySelector(".output-11").innerHTML = data.value + 55;
}
...
function fn12() {
  const firstName = document.querySelector(".field-12-1").value;
  const secondName = document.querySelector(".field-12-2").value;
  document.querySelector(".output-12").innerHTML = `Hello ${firstName} ${secondName}`;
}
...
function fn13() {
  const a = Number(document.querySelector(".field-13-1").value);
  const b = Number(document.querySelector(".field-13-2").value);
  document.querySelector(".output-13").innerHTML = a + b;
}
...
function fn15() {
  const inputBorder = document.querySelector(".field-15");
  inputBorder.style.border = "4px solid red";
}
...
function fn16() {
  const a = document.querySelector(".field-16-1").value;
  const b = document.querySelector(".field-16-2").value;
  document.querySelector(".output-16").innerHTML = a + b;
}
...
function fn18() {
  let a = document.querySelector(".field-18").value;
...
function fn19() {
  const a = document.querySelector(".field-19-1").value;
  const b = document.querySelector(".field-19-2").value;
  document.querySelector(".output-19").innerHTML = Number(a) + Number(b);
}
