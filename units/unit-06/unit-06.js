...
function fn1() {
  document.querySelector(".output-1").innerHTML = number1;
}
...
document.querySelector(".btn-2").onclick = function () {
  ...
  console.log(5 + fn2()); // має вивести 20
  console.log(6 * fn2()); // має вивести 90
  console.log(fn2() * fn2() * fn2()); // 3375
};
...
document.querySelector(".btn-4").onclick = function () {
  document.querySelector(".output-4").textContent = fn4(1994); // тут можна вказати свій вік
};
...
document.querySelector(".btn-6").onclick = function () {
  document.querySelector(".output-6").textContent = fn6(5, 20); // виклик функції
};
...
document.querySelector(".btn-9").onclick = function () {
  document.querySelector(".output-9").textContent = fn9(12); // виклик функції
};
...
document.querySelector(".btn-10").onclick = function () {
  document.querySelector(".output-10").textContent = fn10(30, 200); // виклик функції
};
